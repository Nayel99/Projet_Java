...
public class InterfaceChoixVirus extends JFrame{
	...
	public int actionContamination() {
		return Integer.parseInt(MessageContamination.getText());
	}
	
	public double actionMortalite() {
		return (double) Float.parseFloat(MessageMortalite.getText());
		
	}
	
	public int actionGuerison() {
		return Integer.parseInt(MessageGuerison.getText());  	
	}

	public int actionIncubation(){
		return Integer.parseInt(MessageIncubation.getText());
	}
	...
	public void actionOk() {
		if (MessageNom.getText() != " " 
			...
			virus_Utilisateur = new Virus(actionGuerison(),actionContamination(),actionIncubation(),actionMortalite());
